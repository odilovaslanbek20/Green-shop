								...
								<div className='p-[40px] max-[530px]:p-[20px] mb-[20px]'>
									<div className='flex items-center gap-[50px] max-[898px]:gap-[20px] max-[471px]:flex-col max-[471px]:gap-[0px]'>
										<div className=''>
											...
											<button className='w-[140px] h-[40px] rounded-[6px] bg-[rgba(70,163,88,1)] font-bold text-[16px] font-["Inter] text-[#fff] mt-[44px] max-[980px]:mt-[30px] max-[786px]:w-[110px] max-[786px]:h-[35px] max-[898px]:mt-[20px] max-[786px]:mt-[15px] max-[786px]:text-[14px] max-[652px]:bg-transparent max-[652px]:text-[rgba(70,163,88,1)] max-[652px]:flex max-[652px]:items-center max-[652px]:gap-[1px] max-[652px]:mt-0 max-[530px]:text-[12px]'>
												{card?.btnText}
